            ...
            <div className='mainBoxx-welcome'>
                        ...
                        <div className='textbox'>
                            <div className='welcometextt'>
                                ...
                                Si vous êtes ici/arrivé jusqu'à cette page/, c'est sans doute parce que nous avons reperé votre charisme /chez vous un charisme qui nous inspire/ et votre capacité à impacter le monde.
                                <br/>
